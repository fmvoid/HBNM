...
n_particles=100
n_tasks=1
output_directory="M3_TIS_Myelin_Group"
fc_vector_path="/home/frank/TMS_fMRI/fc_output/group_means/TIS_mean_fc.npy"
...
custom_priors="0.001,5.0;0.0,15.0;0.001,5.0;0.0,15.0;0.001,5.0"
